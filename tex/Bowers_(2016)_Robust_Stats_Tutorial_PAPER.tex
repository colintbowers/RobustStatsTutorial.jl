...
\section{Introduction}\label{secRSTIntroduction}

The field of Robust Statistics provides statistical methods for use with non-Gaussian data. In particular, Robust Statistics are useful when the data generating process is leptokurtotic, that is, when the data exhibits fat-tails. 
